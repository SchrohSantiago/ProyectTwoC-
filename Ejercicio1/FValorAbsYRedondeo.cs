...
{
    public partial class FValorAbsYRedondeo : Form
    {
        public FValorAbsYRedondeo()
        {
            InitializeComponent();
        }
        ...
        private void btnTransformarAValorAbs_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("El valor absoluto es " + valorAbs);
        }

        private void btnRedondearValor_Click(object sender, EventArgs e)
        {
            double num = Convert.ToDouble(txtValorDosCifras.Text);
            ...
            MessageBox.Show("El valor redondeado es " + valorRedondeado);
        }
    }
}
